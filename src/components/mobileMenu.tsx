...
export function MobileMenu({ menuItems, className }: MobileMenuProps) {
  ...
  return (
    <div className={`flex flex-col items-center space-y-4 ${className}`}>
      ...
      <div
        className={`flex-w-full absolute inset-y-0 left-0 w-full bg-primary/90 backdrop-blur-sm min-h-screen border-r border-white/20 shadow-sm z-[6] max-w-xs ${
      ...
      >
        <div className="flex items-center justify-between w-full">
          ...
          <button className="flex items-center justify-center mr-4 mt-1 hover:bg-white/10 rounded-full p-2" onClick={handleToggleMenu}>
